...
from utils.helpers.image_file_path import sunscreen_image

class SunscreenModel(TimeStampedModel):
    ...
    image1 = models.ImageField(upload_to=sunscreen_image)
    image2 = models.ImageField(upload_to=sunscreen_image)
